...
namespace Elite4SDemo.SenseShield
{
    public class Sense4
    {
        ...
        private const string dllName32 = "/dll/x86/sense4.dll";
        private const string dllName64 = "/dll/x64/sense4.dll";
        ...
        internal static int S4Enum([Out, MarshalAs(UnmanagedType.LPArray)] SENSE4_CONTEXT[] s4Constext, ref int size)
        {
            if (Is64())
            {
                return Sense4.S4Enum64(s4Constext, ref size);
            }

            return Sense4.S4Enum32(s4Constext, ref size);
        }
        ...
        internal static int S4Control(ref SENSE4_CONTEXT s4Ctx, int ctlCode, byte[] inBuff, int inBuffLen, byte[] outBuff, int outBuffLen, ref int BytesReturned)
        {
            if (Is64())
            {
                return Sense4.S4Control64(ref s4Ctx, ctlCode, inBuff, inBuffLen, outBuff, outBuffLen, ref BytesReturned);
            }

            return Sense4.S4Control32(ref s4Ctx, ctlCode, inBuff, inBuffLen, outBuff, outBuffLen, ref BytesReturned);
        }
        ...
        internal static int S4Execute(ref SENSE4_CONTEXT s4Ctx, string lpszFileID, byte[] pInBuff, int dwInbufferSize, byte[] pOutBuffer, int dwOutBufferSize, ref int pdwBytesReturned)
        {
            if (Is64())
            {
                return Sense4.S4Execute64(ref s4Ctx, lpszFileID, pInBuff, dwInbufferSize, pOutBuffer, dwOutBufferSize, ref pdwBytesReturned);
            }

            return Sense4.S4Execute32(ref s4Ctx, lpszFileID, pInBuff, dwInbufferSize, pOutBuffer, dwOutBufferSize, ref pdwBytesReturned);
        }
        ...
        internal static int S4ExecuteEx(ref SENSE4_CONTEXT s4Ctx, string lpszFileID, int dwFlag, byte[] pInBuff, int dwInbufferSize, byte[] pOutBuffer, int dwOutBufferSize, ref int pdwBytesReturned)
        {
            if (Is64())
            {
                return Sense4.S4ExecuteEx64(ref s4Ctx, lpszFileID, dwFlag, pInBuff, dwInbufferSize, pOutBuffer, dwOutBufferSize, ref pdwBytesReturned);
            }

            return Sense4.S4ExecuteEx32(ref s4Ctx, lpszFileID, dwFlag, pInBuff, dwInbufferSize, pOutBuffer, dwOutBufferSize, ref pdwBytesReturned);
        }
    }
